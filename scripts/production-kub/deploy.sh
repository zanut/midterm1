...
docker buildx build --platform linux/amd64 -t $CONTAINER_REGISTRY/gateway:3 --file ../../gateway/Dockerfile-prod ../../gateway --push
docker buildx build --platform linux/amd64 -t $CONTAINER_REGISTRY/advertise:2 --file ../../advertise/Dockerfile-prod ../../advertise --push
